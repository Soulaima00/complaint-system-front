...
export class ReclamationService {
  ...
  create(message: string, sousTypeReclamation: ISousTypeReclamation, createdBy: string,idCreator: number, image: File): Observable<EntityResponseType> {
    ...
    data.append('reclamation', new Blob([JSON.stringify({
      message, sousTypeReclamation, createdBy,idCreator,
